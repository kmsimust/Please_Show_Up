...
def upload_file(serializer, uploaded_file, table_name):
    ...
    uploaded_name = f"{table_name}_{serializer_dict["id"]}_{int(time.time() * 1000)}.{file_ext}" #get the file name and it's type
